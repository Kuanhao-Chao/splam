...
os.makedirs("./NEG_rev_junctions/"+SEQ_LENGTH+"bp/")
...
def task(description, sequence):
    fw_donor = open("./NEG_rev_junctions/"+SEQ_LENGTH+"bp/donor/"+description+"_donor.bed", "w")
    fw_acceptor = open("./NEG_rev_junctions/"+SEQ_LENGTH+"bp/acceptor/"+description+"_acceptor.bed", "w")
    fw_da = open("./NEG_rev_junctions/"+SEQ_LENGTH+"bp/d_a/"+description+"_d_a.bed", "w")
