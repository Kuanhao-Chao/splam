...
echo ./Step_7_gffcompare.sh $SAMPLE BEFORE  $MODEL
./Step_7_gffcompare.sh $SAMPLE BEFORE $MODEL

echo ./Step_7_gffcompare.sh $SAMPLE AFTER $MODEL
./Step_7_gffcompare.sh $SAMPLE AFTER $MODEL