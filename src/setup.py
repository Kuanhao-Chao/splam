...
# extension_module = Extension('splam_extract', 
#                             #  sources=['src/splam_extract.cpp'], 
#                              libraries=['splam_extract.cpython-38-darwin.so'],
#                              library_dirs=['./build'])
# __version__ = "0.0.1"

# ext_modules = [
#     Pybind11Extension('splam',  # Replace with the actual package and module names
#                     sources=['src/splam_extract.cpp',
# 							'src/extract.cpp',
# 							'src/junc_func.cpp',
# 							'src/util.cpp',
# 							'src/tmerge.cpp',
# 							'src/GSam.cpp',
# 							'include/gclib/GStr.cpp',
# 							'include/gclib/GArgs.cpp',
# 							'include/gclib/GBase.cpp',
# 							# 'include/gclib/GBase.h'
#                              ],  # Add any C/C++ source files if needed
