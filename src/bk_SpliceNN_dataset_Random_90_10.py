...
class myDataset(Dataset):
    def __init__(self, segment_len=SEQ_LEN):
        ...
        #################################
        pidx = 0
        with open("./INPUTS/"+TARGET+"/input_pos_100.shuffle.fa", "r") as f:
        ...
        #################################
        nidx = 0
        with open("./INPUTS/"+TARGET+"/input_neg.shuffle.fa", "r") as f:
            lines = f.read().splitlines()
            seq_name = ""
            seq = ""
            for line in lines:
        ...
        #################################
        nnidx = 0
        with open("./INPUTS/"+TARGET+"/input_noncan_neg.shuffle.fa", "r") as f:
            lines = f.read().splitlines()
            seq_name = ""
            seq = ""
            for line in lines:
