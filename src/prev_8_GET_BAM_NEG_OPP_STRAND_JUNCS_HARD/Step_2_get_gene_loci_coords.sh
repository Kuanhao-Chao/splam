...
bedtools intersect -wa -wb -a ./BAM_junctions/gencode.v43.chr_patch_hapl_scaff.annotation.merge.pos.only.bed -b BAM_junctions/junctions_5_2.bed -sorted -filenames > ./BAM_junctions/neg_hits.bed

bedtools intersect -wa -wb -a ./BAM_junctions/gencode.v43.chr_patch_hapl_scaff.annotation.merge.pos.only.bed -b BAM_junctions/junctions_5_2.bed > ./BAM_junctions/neg_hits.bed

bedtools intersect -wa -wb -a ./BAM_junctions/gencode.v43.chr_patch_hapl_scaff.annotation.merge.neg.only.bed -b BAM_junctions/junctions_5_2.bed > ./BAM_junctions/pos_hits.bed