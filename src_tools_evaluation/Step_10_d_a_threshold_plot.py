...
def main():
    ...
    for TARGET in ["noN", "N"]:
        if TARGET == "noN":
            spliceai_threshold = 0.0009
        elif TARGET == "N":
            spliceai_threshold = 0.0089
        ...
        for SPLAM_VERSION in ["SPLAM_v11", "SPLAM_v12"]:
            ...
            plt.plot(THRESHOLDS, spliceai_FN__splam_TP, label="SPLAM_TP__SpliceAI_FN")
            plt.plot(THRESHOLDS, spliceai_FP__splam_TN, label="SPLAM_TN__SpliceAI_FP")

            plt.plot(THRESHOLDS, spliceai_TP__splam_FN, label="SPLAM_FN__SpliceAI_TP")
            plt.plot(THRESHOLDS, spliceai_TN__splam_FP, label="SPLAM_FP__SpliceAI_TN")

            plt.plot(THRESHOLDS, spliceai_FN__splam_FN, label="SPLAM_FN__SpliceAI_FN")
            plt.plot(THRESHOLDS, spliceai_FP__splam_FP, label="SPLAM_FP__SpliceAI_FP")
            ...
            plt.tight_layout()
            plt.savefig("IMG/" + SPLAM_VERSION + "/TP_TN_FP_FN/"+TARGET+"/threshold.png", dpi=300)
            # plt.show()
            plt.close()
