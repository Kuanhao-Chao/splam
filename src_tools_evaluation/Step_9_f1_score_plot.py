...
def plot_DT_plot(true_labels, predict_probabilities, SPLAM_VERSION, target):
    ...
    print(f'optimal_threshold: {optimal_threshold:.4f}, Precision: {optimal_precision:.2f}, Recall: {optimal_recall:.2f}, F1 score: {optimal_f1_score:.2f}, Queue rate: {optimal_queue_rate:.2f}')
    ...
    plt.title(f'optimal_threshold: {optimal_threshold:.4f}, Precision: {optimal_precision:.2f}, Recall: {optimal_recall:.2f}, F1 score: {optimal_f1_score:.2f}, Queue rate: {optimal_queue_rate:.2f}')
    plt.xticks(size = 10)
    plt.yticks(size = 10)
    plt.tight_layout()
    # plt.show()
