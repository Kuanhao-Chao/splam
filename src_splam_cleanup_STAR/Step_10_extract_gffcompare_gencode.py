...
for annotation in ["refseq_ucsc"]:#["chess",  "gencode",  "refseq_ucsc"]:
    ...
    for condition in ["BEFORE", "AFTER"]:
        # PolyA result
        dir_name = "../results/polyA_STAR/assembly/"+annotation+"/"
        ...
        with open(filename, "w") as fw:
            ...
            for sample in ["R2826", "R2835",  "R2839",  "R2845",  "R2855",  "R2857",  "R2869",  "R2874",  "R2894",  "R2895"]:
                file_name = "../results/polyA_STAR/"+sample+".bamAligned.sortedByCoord.out/gffcompare/"+annotation+"/"+condition+"/res.stats"
        ...
        # ribozero result
        dir_name = "../results/ribozero_STAR/assembly/"+annotation+"/"
        os.makedirs(dir_name, exist_ok=True)
        filename = dir_name + condition+".tsv"
        ...
        with open(filename, "w") as fw:
            ...
            for sample in ["R12258", "R12260", "R12263", "R12265", "R12266", "R12277", "R12278", "R12280", "R12285", "R12287"]:
                file_name = "../results/ribozero_STAR/"+sample+".bamAligned.sortedByCoord.out/gffcompare/"+annotation+"/"+condition+"/res.stats"
