...
h5f = h5py.File(data_dir + 'data/dataset_test.h5', 'r')
model_file = "MODEL/SpliceNN_spliceAI_pytroch_e_1300.pt"
print(h5f.keys())
num_idx = len(list(h5f.keys()))//2
idx_all = np.random.permutation(num_idx)

print("len(idx_train): ", len(idx_all))
print("idx_train: ", idx_all)
