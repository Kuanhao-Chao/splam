...
def main():
    ...
    for output_file in output_files:
        fw_donor = open(output_file+"splam.juncs.donor.bed", "w")
        fw_acceptor = open(output_file+"splam.juncs.acceptor.bed", "w")
        
        # d_a_bed = "./OUTPUT/splam.juncs.bed"
        # fw_da = open(d_a_bed, "w")
        JUNCS = set()

        with open(output_file+"splam.juncs.bed", "r") as f:
