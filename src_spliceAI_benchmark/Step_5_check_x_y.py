...
def main():
    ...
    for target in ["spliceai", "spliceai.N", "splam"]:
        fr_da = open("./output/"+target+".juncs.seq.fa", "r")
        print("Target file: ", "./output/"+target+".juncs.seq.fa")
        ...
        for idx in range(line_num):
            if idx % 2 == 0:
                ...
                if (target == "spliceai"):
                    ...
                    donor_dimer = x[5100:5100+2]
                    acceptor_dimer = x[len_seq-5100-2:len_seq-5100]
