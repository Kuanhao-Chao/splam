...
def main():
    ...
    for output_file in output_files:
        ...
        fw = open(output_file+"splam.juncs.seq.fa", "w")
        fr_donor = open(output_file+"splam.juncs.donor.seq.fa", "r")
        fr_acceptor = open(output_file+"splam.juncs.acceptor.seq.fa", "r")
