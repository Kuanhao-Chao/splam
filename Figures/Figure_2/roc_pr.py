...
def main():
    ...
    for MANE_OR_ALTS in ["pos_MANE", "pos_ALTS"]:
        with open("../../src_tools_evaluation/spliceai_result/spliceai.da.N.merged."+MANE_OR_ALTS+".pkl", "rb") as fr:
        ...
        with open("../../src_tools_evaluation/spliceai_result/spliceai.da.noN.merged."+MANE_OR_ALTS+".pkl", "rb") as fr:
